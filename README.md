...
<!-- Short Summary -->
<p align="center">
  Centralized analytics platform to monitor national freight flows
</p>

<!-- Useful Links-->
<p align="center">
    <strong>
        <a href="" target="_blank">Web App</a>
        •
        <a href="https://github.com/seb-sto/freight-flow-platform/docs" target="_blank">Documentation</a>
    </strong>
</p>
...
### Built with
The project contains mainly folllwing frameworks/libraries:
